...
public class LoginEtudiantController {
	...
	public String index() {
		return "redirect:/etudiant-panel/login";
	}
	...
	public String logout() {
		...
		return "redirect:/etudiant-panel/login?logout";
	}
