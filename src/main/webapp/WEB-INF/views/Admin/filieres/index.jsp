      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
            	<c:url value="filiere/ajouter" var="ajouter"></c:url>
	            <a href="${ajouter }" class="btn btn-primary btn-icon-split">	                  
	                  <span class="text">Ajouter une filière</span>
	            </a>
	            <br><br>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  	<c:forEach items="${fils}" var="fil">
                    	<tr>
	                      <td>${ fil.nom } </td>
	                      <td>${fil.departement.nom } </td>
	                     <c:url value="filiere/modifier/${fil.getIdFil() }" var="modifier"></c:url>
	                      <td>
	                      <a href="${modifier }"><i class="far fa-edit" style="color: green"></a></i> 
	                      | 
	                      <c:url value="filiere/supprimer/${fil.getIdFil() }" var="supprimer" />
