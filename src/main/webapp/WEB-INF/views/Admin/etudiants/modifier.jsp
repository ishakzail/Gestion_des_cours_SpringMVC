        ...
        <!-- Begin Page Content -->
             ...
             <div class="p-4">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Modifier l'étudiant ${etudiant.nom }</h1>
                  </div>
                  <c:url value="/admin/etudiant/modifier"  var="modifier" />
                  <f:form  action="${modifier }" modelAttribute="etudiant" method="post" role="form">
                  	<f:hidden path="idEtud"/>
